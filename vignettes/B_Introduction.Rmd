...
The `ListGeneExp` function is used to rearrange the input gene expression files from The Cancer Genome Atlas (TCGA), Gene Expression Omnibus (GEO), and other sources to get an overall gene expression list of entire samples.
