...
```
ListGeneExp(file = '*level3.data.txt', directory = system.file("extdata/GE", package = "iGC"), tcga = TRUE, probe = FALSE, outputList = TRUE)
load("GeneExp.rda")
dim(GeneExp)
head(GeneExp)
```
...
```
CNAtoGene(file.pattern = '*\\.hg19.seg.txt', directory = system.file("extdata/CNA", package = "iGC"), tcga = TRUE, cna.gain.threshold = 2.7, cna.loss.threshold = 1.3, col.sample = 1, col.chromosome = 2, col.startloci = 3, col.endloci = 4, col.seg.mean = 6, outputList = True)
