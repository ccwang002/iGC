...
sample_desc <- as.data.table(sample_desc)
sample_desc$CNA_filepath <- as.character(sample_desc$CNA_filepath)
sample_desc$Sample <- as.character(sample_desc$Sample)

setnames(gene_exp, "gene.ep.unisym", "GENE")
...
my_cna_reader <- function(cna_filepath) {
  # cna <- read.csv(
  #   cna_filepath, 
  #   col.names=c("GENE", "Chromosome", "Start", "End", "Segment_Mean"), 
  ...
  setnames(cna, c("GENE", "Chromosome", "Start", "End", "Segment_Mean"))
  cna
}
