...
Third, we apply the `create_gene_exp` function to create an overall gene expression list of entire input samples. The output file will be saved as gene_exp.rda.
