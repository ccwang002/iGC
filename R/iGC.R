...
#'
#'
#' @section create_gene_exp function:
...
#'
#' @section find_cna_drive_gene function:
#' The find_cna_drive_gene function identifies CNA-driven differentially expressed genes. The input mapped genes
